...
/**
 This class is the activity class and interacts with activity_new_york.xml
 provides the user with options when placing an order for a New York style pizza
...
public class NewYorkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        crust = findViewById(R.id.crust1);
        pizzaPrice = findViewById(R.id.pizzaPrice1);
        imageView = findViewById(R.id.pizzaImage1);
        toppingsTextView = findViewById(R.id.toppingsTextView1);
        toppingsText = findViewById(R.id.toppingsText1);
    ...
    private void setUpSpinner() {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                setAsBuildYourOwn();
                Intent intent = new Intent(NewYorkActivity.this, ToppingsSelectedActivity.class);
                intent.putExtra("calling class", "NewYorkActivity");
